...
//// NOTE : I MADE FUNCTIONS get_J, get_row PUBLIC AND DISABLED ALL MAX. DEGREE WARNINGS. THIS HAS TO BE FIXED WHEN PROPERLY IMPLEMENTED
int main(){
    // //INTERMEDIATE OUTPUT
    // std::ofstream file;
    ...
    for (int degree=7; degree <=7; degree*=2){
        cout << "[" << endl;
        for (int nvar=5; nvar<=5; nvar++){
            //TIME
