void initialize_polyb (long long int polyb[1111]){
   long long int polyb_aux[1111] =
  {
      ...
      for (int i=0; i<1111; i++)    polyb[i]=polyb_aux[i];
}

void initialize_v (long long int v[1111][62]){
//  Initialize (part of) V (fold code for legibility)
//
    v[2][1] = 1;
    v[3][1] = 3;
    v[4][1] = 1;
